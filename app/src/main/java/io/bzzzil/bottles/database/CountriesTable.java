...
public class CountriesTable {
    ...
    private static void insertCountries(SQLiteDatabase db)
    {
        ...
        db.execSQL("insert into " + CountriesTable.TABLE_COUNTRIES + " values ('AI', '" + BottlesApplication.getContext().getString(R.string.country_anguilla) + "', " + R.drawable.anguilla + ")");
        db.execSQL("insert into " + CountriesTable.TABLE_COUNTRIES + " values ('BM', '" + BottlesApplication.getContext().getString(R.string.country_bermuda) + "', " + R.drawable.bermuda + ")");
        ...
        db.execSQL("insert into " + CountriesTable.TABLE_COUNTRIES + " values ('KY', '" + BottlesApplication.getContext().getString(R.string.country_cayman_islands) + "', " + R.drawable.cayman_islands + ")");
        ...
        db.execSQL("insert into " + CountriesTable.TABLE_COUNTRIES + " values ('AS', '" + BottlesApplication.getContext().getString(R.string.country_american_samoa) + "', " + R.drawable.american_samoa + ")");
        ...
        db.execSQL("insert into " + CountriesTable.TABLE_COUNTRIES + " values ('AW', '" + BottlesApplication.getContext().getString(R.string.country_aruba) + "', " + R.drawable.aruba + ")");
